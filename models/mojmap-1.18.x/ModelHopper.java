...
public class ModelHopper<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "hopper"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leg = partdefinition.addOrReplaceChild("Leg",
				CubeListBuilder.create().texOffs(14, 11)
						.addBox(-1.0F, -5.0F, -1.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition Tentacles = partdefinition.addOrReplaceChild("Tentacles",
				CubeListBuilder.create().texOffs(20, 4)
						.addBox(-2.0F, -6.0F, -2.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 4)
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -12.0F, -3.0F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(15, 0)

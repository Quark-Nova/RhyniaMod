...
public class ModelRammer<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rammer"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leftleg = partdefinition.addOrReplaceChild("Leftleg", CubeListBuilder.create().texOffs(39, 43)
				.addBox(-2.0F, -2.0F, -2.5F, 4.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -16.0F, -9.0F, 8.0F, 9.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(31, 0)

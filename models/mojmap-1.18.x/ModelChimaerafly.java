...
public class ModelChimaerafly<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "chimaerafly"), "main");
	private final ModelPart Legs;
	private final ModelPart Tail;
	private final ModelPart Wingpivot;
	private final ModelPart Wingpivot2;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Tail = partdefinition.addOrReplaceChild("Tail",
				CubeListBuilder.create().texOffs(11, 8)
						.addBox(-1.0F, 0.6F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-0.5F, 0.6F, 3.0F, 1.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, 21.4F, 3.0F));

		PartDefinition Wingpivot = partdefinition.addOrReplaceChild("Wingpivot", CubeListBuilder.create(),
				PartPose.offset(-1.4F, 22.0F, 0.4F));

		PartDefinition Wing_r1 = Wingpivot
				.addOrReplaceChild("Wing_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-1.3536F, 0.0F, -0.6804F, 3.0F, 0.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.5236F, 0.0F));

		PartDefinition Wingpivot2 = partdefinition.addOrReplaceChild("Wingpivot2", CubeListBuilder.create(),
				PartPose.offset(0.4F, 22.0F, 0.4F));

		PartDefinition Wing_r2 = Wingpivot2
				.addOrReplaceChild("Wing_r2",
						CubeListBuilder.create().texOffs(6, 0).addBox(-1.6464F, 0.0F, -0.6804F, 3.0F, 0.0F, 8.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.5236F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 8)
						.addBox(-2.0F, -2.0F, -1.0F, 3.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 4)
						.addBox(-1.5F, -2.0F, -3.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

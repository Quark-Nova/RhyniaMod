...
public class ModelAirtrawler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "airtrawler"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-0.5F, -2.0F, -8.0F, 1.0F, 1.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
		...
		PartDefinition GreatHindwing_r1 = bb_main.addOrReplaceChild(
				"GreatHindwing_r1", CubeListBuilder.create().texOffs(15, 0).addBox(-9.0F, 0.99F, -1.0F, 9.0F, 0.0F,
		...
		PartDefinition GreatHindwing_r2 = bb_main.addOrReplaceChild("GreatHindwing_r2",
				CubeListBuilder.create().texOffs(15, 3).addBox(0.0F, 0.99F, -1.0F, 9.0F, 0.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 1.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition Post_Wing_r1 = bb_main.addOrReplaceChild("Post_Wing_r1",
				CubeListBuilder.create().texOffs(0, 17).addBox(-8.0F, 0.995F, 0.0F, 8.0F, 0.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Post_Wing_r2 = bb_main.addOrReplaceChild("Post_Wing_r2",
				CubeListBuilder.create().texOffs(17, 10).addBox(0.0F, 0.995F, 0.0F, 8.0F, 0.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -6.0F, 0.0F, -0.2618F, 0.0F));

		PartDefinition GreatWing_r1 = bb_main.addOrReplaceChild("GreatWing_r1",
				CubeListBuilder.create().texOffs(16, 6).addBox(-9.0F, 0.99F, -1.0F, 9.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition GreatWing_r2 = bb_main.addOrReplaceChild("GreatWing_r2",
				CubeListBuilder.create().texOffs(16, 8).addBox(0.0F, 0.99F, -1.0F, 9.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, -6.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition Tailrod_r1 = bb_main
				.addOrReplaceChild("Tailrod_r1",
						CubeListBuilder.create().texOffs(6, 5).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition Tailrod_r2 = bb_main.addOrReplaceChild("Tailrod_r2",
				CubeListBuilder.create().texOffs(0, 9).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Tailrod_r3 = bb_main.addOrReplaceChild("Tailrod_r3",
				CubeListBuilder.create().texOffs(6, 10).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.5F, 7.5F, -0.3491F, -0.5236F, 0.0F));

		PartDefinition Head_r1 = bb_main.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(9, 2).addBox(0.0F, -0.5F, -1.6F, 1.0F, 1.0F, 2.0F,
						new CubeDeformation(0.0F)),

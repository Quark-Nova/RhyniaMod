...
public class ModelPanzerlach<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "panzerlach"), "main");
	private final ModelPart LFleg;
	private final ModelPart RFleg;
	private final ModelPart LHleg;
	private final ModelPart RHleg;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LFleg = partdefinition
				.addOrReplaceChild("LFleg",
						CubeListBuilder.create().texOffs(18, 34).addBox(-1.5F, -2.0F, -2.0F, 3.0F, 8.0F, 4.0F,
		...
		PartDefinition RFleg = partdefinition.addOrReplaceChild("RFleg",
				CubeListBuilder.create().texOffs(30, 0).addBox(-1.5F, -2.0F, -2.0F, 3.0F, 8.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LHleg = partdefinition.addOrReplaceChild("LHleg",
				CubeListBuilder.create().texOffs(0, 36)
						.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 14)
						.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(1, 1)
						.addBox(-1.0F, 7.0F, -4.0F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RHleg = partdefinition.addOrReplaceChild("RHleg",
				CubeListBuilder.create().texOffs(32, 34)
						.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(1, 0)
						.addBox(-1.0F, 7.0F, -4.0F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 17.0F, 11.0F, 0.3054F, 0.4363F, 0.0F));

		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -11.0F, -5.0F, 5.0F, 6.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
		...
		PartDefinition Lowerjaw_r1 = bb_main.addOrReplaceChild("Lowerjaw_r1",
				CubeListBuilder.create().texOffs(22, 26).addBox(-2.0F, 0.0F, -6.0F, 5.0F, 2.0F, 6.0F,
						new CubeDeformation(0.0F)),

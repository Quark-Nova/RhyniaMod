...
public class ModelBaguettesquid<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("baguettesquids", "model_baguettesquid"),
			"main");
	public final ModelPart Squid;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Squid = partdefinition.addOrReplaceChild("Squid",
				CubeListBuilder.create().texOffs(0, 4).addBox(1.0F, -5.0F, -12.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(7, 7)
